    ...
    <div id = "head">
        ...
        <div class="menu-right">
            <div class="menu">
                ...
                <label for="menu_bar01"><p class="menu-name">{{Auth::user()->username}}&nbsp;さん&nbsp;&nbsp;</p></label>
                <ul id="links01" class="menu-ul">
                    <li class="menu-li"><a href="/top">HOME</a></li>
                    <li class="menu-li"><a href="/profile">プロフィール編集</a></li>
                    <li class="menu-li"><a href="/logout">ログアウト</a></li>
                </ul>
            </div>
